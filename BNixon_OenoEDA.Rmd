...
trend of higher alcohol associating with higher quality, and vice versa.  The 
blue line is a linear model fit to the data and demonstrates the positive trend.
A stronger trend is that 'good' wines (with scores from 5-7) span a broad range
of alcohol content, between 9 and 11%, as well as demonstrating a the same trend 
of higher alcohol correlating with higher quality. The correlation test yields a 
0.48 correlation between alcohol and quality. 
...
###   CORRELATION TEST (COEFFICIENT OF CORR. / PEARSONS R) SHOWS THE STRENGTH OF THE LINEARITY
### THE SLOPE OF THE LINE HAS NOTHING TO DO WITH PEARSONS R / THE STRENGTH OF THE RELATIONSHIP
